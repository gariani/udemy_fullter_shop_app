...
mixin _$Cart {
  ...
  set items(Map<String, CartItem> value) => throw _privateConstructorUsedError;
...
abstract class $CartCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, CartItem> items, double totalAmount});
}
...
class _$_Cart implements _Cart {
  _$_Cart({required this.items, required this.totalAmount});
...
abstract class _Cart implements Cart {
  factory _Cart(
      ...
      required double totalAmount}) = _$_Cart;
